...
import { SelectList } from "../DomainSGI/DNSRegisterSelect/SelectList";
import { RegATable } from "../DomainSGI/RecordsTable/RegATable";
import { RegAAAATable } from "../DomainSGI/RecordsTable/RegAAAATable";
import { RegMXTable } from "../DomainSGI/RecordsTable/RegMXTable";
import { RegCNAMETable } from "../DomainSGI/RecordsTable/RegCNAMETable";
import { RegTXTTable } from "../DomainSGI/RecordsTable/RegTXTTable";
  ...
  return (
    <div className="container__dnsregister">
      <div className="container__dnsReg">
        <div className="container__dnsregister--tittle">Registros DNS</div>
      </div>
