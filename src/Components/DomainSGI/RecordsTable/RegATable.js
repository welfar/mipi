...
import { deleteRecord, getRecords } from "../../../actions/records.js";
import { EditRow } from "./Edit Row/EditRowRegA.js";
import Loader from "../../Principal/Loader.js";
import { FaEdit, FaTrashAlt } from "react-icons/fa";

import "../../../Styles/DomainSGI/RecordsTable/RecordsTable.css";

export const RegATable = ({ domainName }) => {
  ...
  useEffect(() => {
    dispatch(getRecords(domainName, "A"));
  }, [dispatch, domainName]);
