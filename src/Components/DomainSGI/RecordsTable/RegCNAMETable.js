...
import { EditRow } from "./Edit Row/EditRowRegCNAME";
...
export const RegCNAMETable = ({ domainName }) => {
  ...
  useEffect(() => {
    dispatch(getRecords(domainName, "CNAME"));
  }, [dispatch, domainName]);
    ...
    <>
      <div className="table__containter">
        ...
        >
          ...
          <div className="names_colums" style={{ width: "40%" }}>
            DESTINO
          </div>
          {(adm === "SUPERUSER" ||
            lider === "LIDER" ||
                ...
                <div key={index}>
                  ...
                  {editMode && index === indexEdit ? (
                    <EditRow
                      ...
                      purpose={item.content.slice(0, -1)}
