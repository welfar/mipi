...
export const RegTXTTable = ({ domainName }) => {
  ...
  useEffect(() => {
    dispatch(getRecords(domainName, "TXT"));
  }, [dispatch, domainName]);
    ...
    <>
      <div className="table__containter">
        ...
        >
          ...
          <div className="names_colums" style={{ width: "50%" }}>
            DESTINO
          </div>
          {(adm === "SUPERUSER" ||
            lider === "LIDER" ||
